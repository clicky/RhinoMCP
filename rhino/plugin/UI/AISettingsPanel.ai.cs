...
//         AgentRegistry.Instance.TryGet(row.Command, out AgentDefinition def);
...
//         // AgentRegistry.Instance.TryGet

//         // foreach (string model in AgentRegistry.Instance.AllDefinitions
...
//         AgentRegistry.Instance.TryGet(command, out AgentDefinition def);
