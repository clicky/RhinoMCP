...
internal static class RhinoRouterPaths
{
    public static string ResolveBinary()
    {
        ...
        // Mirrors Rhino.AI.csproj: bin/$(RhinoTarget)-$(PluginOS)/$(Configuration)/router/$(rid)/.
        ...
        throw new FileNotFoundException(
            ...
            $"Build the plugin first: `dotnet build rhino/plugin/Rhino.AI.csproj -c Release -p:RhinoTarget={rhinoTarget}`.",
            probed[0]);
    }
