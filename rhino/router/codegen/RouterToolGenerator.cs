...
namespace Rhino.AI.Router.Codegen;
...
public class RouterToolGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(tools.Collect(), static (spc, all) =>
        {
            ...
            sb.AppendLine("namespace Rhino.AI.Router.Tools.Generated;");
            sb.AppendLine();
    ...
    private static void EmitRegistrar(StringBuilder sb, ImmutableArray<ToolInfo> tools)
    {
        ...
        sb.AppendLine("    {");
        sb.AppendLine("        builder = global::Microsoft.Extensions.DependencyInjection.McpServerBuilderExtensions.WithTools<global::Rhino.AI.Router.Tools.SpawnSlotTool>(builder, options);");
        foreach (var tool in tools)
        {
            sb.AppendLine($"        builder = global::Microsoft.Extensions.DependencyInjection.McpServerBuilderExtensions.WithTools<global::Rhino.AI.Router.Tools.Generated.{tool.ClassName}Proxy>(builder, options);");
        }
